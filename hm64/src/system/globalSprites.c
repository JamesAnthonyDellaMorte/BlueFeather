...
bool dmaSprite(u16 index, 
    const void* romTextureStart, const void* romTextureEnd, 
    const void* romAssetsIndexStart, const void* romAssetsIndexEnd, 
    const void* romSpritesheetIndexStart, const void* romSpritesheetIndexEnd, 
    ...
    if (index < MAX_SPRITES) {
        ...
        if (!(globalSprites[index].stateFlags & SPRITE_ACTIVE)) { 
            ...
            nuPiReadRom((uintptr_t)romAssetsIndexStart, assetIndex, (uintptr_t)romAssetsIndexEnd - (uintptr_t)romAssetsIndexStart);
            ...
            if (assetType & 1) {
                ...
                nuPiReadRom((uintptr_t)romTextureStart + offset2, paletteVaddr, offset3 - offset2);
                nuPiReadRom((uintptr_t)romTextureStart + offset3, animationVaddr, offset4 - offset3);
                nuPiReadRom((uintptr_t)romTextureStart + offset4, spriteToPaletteVaddr, offset5 - offset4);
                nuPiReadRom((uintptr_t)romSpritesheetIndexStart, spritesheetIndexVaddr, (uintptr_t)romSpritesheetIndexEnd - (uintptr_t)romSpritesheetIndexStart);

                setSpriteType1(index, animationVaddr, spritesheetIndexVaddr, paletteVaddr, spriteToPaletteVaddr, (u32)(uintptr_t)romTextureStart, texture1Vaddr, texture2Vaddr);

            // spritesheet index in spritesheet
            } else {

                nuPiReadRom((uintptr_t)romTextureStart + offset1, texture1Vaddr, offset2 - offset1);
                nuPiReadRom((uintptr_t)romTextureStart + offset2, paletteVaddr, offset3 - offset2);
                nuPiReadRom((uintptr_t)romTextureStart + offset3, animationVaddr, offset4 - offset3);
                nuPiReadRom((uintptr_t)romTextureStart + offset4, spriteToPaletteVaddr, offset5 - offset4);
