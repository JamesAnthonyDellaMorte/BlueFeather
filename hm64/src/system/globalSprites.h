...
extern bool dmaSprite(u16 index, const void* romTextureStart, const void* romTextureEnd, const void* romAssetsIndexStart, const void* romAssetsIndexEnd, const void* romSpritesheetIndexStart, const void* romSpritesheetIndexEnd, u8* texture1Vaddr, u8* texture2Vaddr, u16* paletteVaddr, AnimationFrameMetadata* animationVaddr, u8* spriteToPaletteVaddr, u32* spritesheetIndexVaddr, u8 assetType, u8 argE);
