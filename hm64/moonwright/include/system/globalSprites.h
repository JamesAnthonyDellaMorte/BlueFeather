...
#ifdef HM64_PC_PORT
typedef u8* HM64RomAddr;
#else
typedef u32 HM64RomAddr;
#endif
...
extern bool dmaSprite(u16 index, HM64RomAddr romTextureStart, HM64RomAddr romTextureEnd, HM64RomAddr romAssetsIndexStart, HM64RomAddr romAssetsIndexEnd, HM64RomAddr romSpritesheetIndexStart, HM64RomAddr romSpritesheetIndexEnd, u8* texture1Vaddr, u8* texture2Vaddr, u16* paletteVaddr, AnimationFrameMetadata* animationVaddr, u8* spriteToPaletteVaddr, u32* spritesheetIndexVaddr, u8 assetType, bool transformExempt);
...
extern bool setSpriteType1(u16 index, u32* animationIndexPtr, u32* spritesheetIndexPtr, u32* paletteIndexPtr, u8* spriteToPaletteMappingPtr, HM64RomAddr romTexturePtr, u8* texturePtr, u8* texture2Ptr);
